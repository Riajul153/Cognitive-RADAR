...
class BeamTrackingTrainer:
    ...
    def train(self) -> None:
        ...
        if resume_path:
            ...
            raise ValueError(f"Unsupported algorithm: {algo}. Must be SAC, TD3, DQN, or RecurrentPPO.")
